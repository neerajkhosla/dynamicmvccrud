...
namespace jTable.Controllers
{
    public class DefaultController : Controller
    {
        ...
        public ContentResult Add()
        {
            ...
            string userid= "1";
            strColumns = strColumns + ",CreatedOn,LastUpdatedOn,CreatedByID,LastUpdatedByID,IsDeleted";
        ...
        public ContentResult Update()
        {
            ...
            //audit fields
            string userid = "1";
            strColumnUpdate = strColumnUpdate + ",LastUpdatedOn = '" + DateTime.Now.ToString() + "'";
